...
import { UNIT_BY_ID, UNITS, sellValue } from './units.js?v=202608271834';
import { Pool, Roster, Economy, SHOP_SIZE, REROLL_COST, XP_COST, XP_PER_ROUND, BENCH_SLOTS, boardCapacity } from './shop.js?v=202608271834';
