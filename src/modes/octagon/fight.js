import { MOVES, COUNTER_MOVE, COUNTER_CLIPS } from '../../moves/index.js?v=202608281148';
...
export function simFight(cfgA, cfgB) {
  const mk = c => ({ hp: 100, stats: c.stats, counterSkill: c.counterSkill, powerKO: c.powerKO });
