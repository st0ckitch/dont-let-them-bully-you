...
export class NetMatch {
  ...
  get side() { return this.isHost ? 'host' : 'guest'; }
...
export function canonicalUnits(hostBoard, guestBoard, makeUnit) {
  return [
